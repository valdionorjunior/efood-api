...
public class CadastroCozinhaService {
    ...
    public static final String MSG_COZINHA_NAO_ENCONTRADA = "Não existe um cadastro de cozinha codigo %d.";
    public static final String MSG_COZINHA_EM_USO = "Cozinha de cogido %d nao pode ser removida, pois está em uso.";
    @Autowired
